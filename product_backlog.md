...
## Login/Registration
### [PRIORITY: HIGH] Account Registration
...
## [PRIORITY: HIGH] Error feedback on login
...
## Home Page
### [PRIORITY: HIGH] View welcome message
...
### [PRIORITY: MEDIUM] Display weekly progress
...
## Habit Management
### [PRIORITY: HIGH] View completed habits
...
## Menu
### [PRIORITY: HIGH] Access menu options
...
### [PRIORITY: HIGH] Navigate to profile
...
### [PRIORITY: MEDIUM] Navigate to habits page
**Description:** As a user, I want to access the habits page from the menu, so that I can configure and manage my habits.
**Lebels**: enhancement, priority: mediam

Here are the user stories with the Asericks (As a user, I want...) and hash keys:

### [PRIORITY: MEDIUM] Sign out from menu
...
### [PRIORITY: MEDIUM] Edit personal information
...
### [PRIORITY: MEDIUM] Add a new habit
...
### [PRIORITY: MEDIUM] Visualize completed habits
...
### [PRIORITY: MEDIUM] Enable/disable notifications
...
### [PRIORITY: MEDIUM] Add habits for notifications
...
### [PRIORITY: MEDIUM] Set notification times
...
### [PRIORITY: LOW] View personal information
...
### [PRIORITY: LOW] Save updated information
...
### [PRIORITY: LOW] Update name in header
...
### [PRIORITY: LOW] Personalize a habit with color
*Description:* As a user, I want to assign a specific color to each habit, so that I can make it personal to me.
*Labels:* enhancement, priority: low

### [PRIORITY: LOW] View all habits
...
*Labels:* enhancement, priority: low
- **Description:** As a user, I want to see visual charts of my habit completion so that I can understand my patterns
- **Labels:** enhancement, priority: low
